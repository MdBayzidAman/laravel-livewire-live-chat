...
return [
    ...
    /*
     ...
     |
     */
    'token_length' =>  env('MOBILE_VERIFICATION_TOKEN_LENGTH', 6),
    ...
    /*
     ...
     |
     */
    'sms_client' => App\Services\SMS\MobileSMS::class,
    ...
    |
    */
    'token_storage' => env('MOBILE_VERIFICATION_TOKEN_STORAGE', 'database'),
